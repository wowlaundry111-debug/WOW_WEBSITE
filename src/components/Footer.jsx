  ...
  return (
    <footer className='mt-20 md:mx-10 bg-black rounded-t-[40px] md:rounded-t-[80px] px-10 lg:px-20 py-16 font-outfit selection:bg-[#9AE600] selection:text-black shadow-[0_-8px_0_#0D8DE3]'>
      <div className='flex justify-center'>
        <picture>
          <source media="(max-width: 640px)" srcSet={logoSm} width="240" height="160" />
          <img src={logo} alt="WOW Laundry - Wear Fresh and Feel Fresh" width="336" height="224" loading="lazy" decoding="async" className="h-44 md:h-56 w-auto object-contain drop-shadow-[0_15px_25px_rgba(0,0,0,0.6)] hover:scale-105 transition-transform duration-300" />
        </picture>
      </div>
