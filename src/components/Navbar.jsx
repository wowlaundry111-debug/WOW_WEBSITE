        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center gap-3 transition-colors">
              <div className="bg-white border-2 border-black rounded-full shadow-[3px_3px_0px_rgba(0,0,0,1)] flex items-center justify-center w-14 h-14 sm:w-18 sm:h-18 overflow-hidden shrink-0">
                <img src={logo} alt="WOW Laundry" className="w-13 h-13 sm:w-17 sm:h-17 object-contain scale-110" />
              </div>
