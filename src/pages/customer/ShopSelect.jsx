    ...
    <div className="min-h-screen bg-white flex flex-col font-outfit selection:bg-black selection:text-white">
      ...
      <div className="flex-1 w-full max-w-2xl mx-auto px-4 py-10">
        <div className="mb-10 animate-fade-in-up">
          <div className="w-16 h-16 rounded-full bg-[#9AE600] border-2 border-black flex items-center justify-center mb-6 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
          ...
          {shops.map((shop, idx) => {
            ...
            return (
              <button
                ...
                className="w-full bg-[#9AE600] rounded-2xl p-6 flex items-center border-2 border-black shadow-[6px_6px_0px_rgba(0,0,0,1)] transition-all active:translate-x-1 active:translate-y-1 active:shadow-none group text-left animate-fade-in-up opacity-0"
              ...
              >
                ...
                <div className="w-12 h-12 rounded-full bg-black flex items-center justify-center text-[#9AE600] group-hover:bg-white group-hover:text-black border-2 border-black transition-colors ml-4 shadow-[4px_4px_0px_rgba(0,0,0,1)]">
